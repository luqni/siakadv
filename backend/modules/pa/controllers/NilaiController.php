...
class NilaiController extends Controller
{
    ...
    // public function actionsNilaidetail()
    // {
    //     $con=pg_connect('host=localhost user=postgress password=sayangibu dbname=dbsiaknf2016');
    // }

    // $query=pg_query($con,"SELECT nama FROM matakuliah");
}
