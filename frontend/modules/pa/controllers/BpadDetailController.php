...
use frontend\modules\pa\models\BimbinganDetailSearch;
 ...
 */
class BpadDetailController extends Controller
{
    /**
     * @inheritdoc
     */
    ...
    public function actionCreate()
    {
        ...
        $idpa = $_GET['idpa'];
        $model->bimbingan_id=$idpa;

        if ($model->load(Yii::$app->request->post()) && $model->save()) {
            return $this->redirect(['bimbingan-pa/view', 'id' => $model->bimbingan_id]);
        } else {
