...
<div class="dosen-form">
    ...
    <?= $form->field($model, 'kode_rombel')->dropDownList(
        ArrayHelper::map(
            ...
            'kode', 'nama'),
        ['prompt' => '-- Pilih Nama Rombel --']
    ) ?>

    <!--
    <?= $form->field($model, 'jk')->dropDownList([ 'L' => 'L', 'P' => 'P', ], ['prompt' => '--Masukan Pilihan--']) ?>
    ...
    <?= $form->field($model, 'agama')->dropDownList([ 'Islam' => 'Islam', 'Kristen' => 'Kristen', 'Khatolik' => 'Khatolik', 'Hindu' => 'Hindu', 'Budha' => 'Budha', 'KongHuCu' => 'KongHuCu', ], ['prompt' => '--Masukan Pilihan--']) ?>
